...
* Terabox downloader (/terabox <link>)
* Social media downloader (/social <url>)
* LLaMA 3.1 AI Chat (/llama <prompt>)
* GPT-3.5 Chat (/gpt <prompt>)
* Admin commands: /stats, /broadcast
* Daily free tier quota per user

Env vars:
* TELEGRAM_BOT_TOKEN – required
* ADMIN_IDS – comma separated list of admin user IDs
* FREE_TIER_LIMIT – daily free limit (default 20)
"""
